/*
	...
	Author: Dom
*/
class nameOfRole { //this class is used when defining which roles are in what group
	...
	maxCount = 5; //the max count of this role that can be played on the server at the same time
