...
private _factionName = getText(missionConfigFile >> DT_bluforFaction >> "Dynamic_Groups" >> "faction_name");
(_display displayCtrl 1000) ctrlSetText format ["%1 %2",_factionName,localize "STR_DT_Role_Menu_Title"];

private _rolesArray = missionConfigFile >> DT_bluforFaction >> "Dynamic_Roles";
private _myPath = [0,0];
