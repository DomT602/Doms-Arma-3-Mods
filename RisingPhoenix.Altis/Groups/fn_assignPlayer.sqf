...
if ([getText(missionConfigFile >> DT_bluforFaction >> "Dynamic_Roles" >> _desiredRole >> "rank")] call _fnc_getRankNumber > [rank (leader _selectedGroup)] call _fnc_getRankNumber) then {
